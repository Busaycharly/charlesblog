...
if (isset($_REQUEST['cat'])){
    $sql1 = "SELECT *, DATE_FORMAT(date, '%a-%d-%b-%Y') as newDate FROM `myblogtable` WHERE category='$_REQUEST[cat]'";
					...
					<div class="grid-box">
                        ...
                        ?>
							<div class="col-md-4">
								...
								<a <?php echo "href='news.php?a=".$row['a']."'"?>><img src="app/image/<?php echo $row['image']; ?>" alt="" height="210px"></a>
										<a class="category-post world" <?php echo "href='cat.php?cat=".$row['category']."'"?>><?php echo $row['category']; ?></a>
									</div>
									<div class="post-title">
										<h2><a <?php echo "href='single-post.php?a=".$row['headline']."'"?>><?php echo $row['headline']; ?></a></h2>
										<ul class="post-tags">
									...
									<div class="post-content">
										...
										<a href='single-post.php?a=<?php echo $row['headline'];?>' class="read-more-button"><i class="fa fa-arrow-circle-right"></i><?php echo $row['headline'];?></a>
									</div>
								</div>
							</div>
                            <?php
