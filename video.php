						...
						<div class="block-content">
							...
							<?php
								...
								if (isset($_REQUEST['id'])){
									$sql1 = "SELECT *, DATE_FORMAT(date, '%a-%d-%b-%Y') as newDate FROM myblogvideo WHERE id='$_REQUEST[id]'";
					...
					<div class="col-md-3 col-sm-4 sidebar-sticky">
						...
						<div class="sidebar large-sidebar theiaStickySidebar">
							...
							<div class="widget features-slide-widget">
								...
								<?php
			$sql="SELECT *, DATE_FORMAT(date, '%a-%d-%b-%Y') as newDate FROM `myblogtable` ORDER BY `id` DESC LIMIT 0, 1";
